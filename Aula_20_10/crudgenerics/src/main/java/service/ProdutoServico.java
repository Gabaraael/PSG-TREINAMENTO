...
public class ProdutoServico extends BaseGenericService<ProdutoRepository> implements IgenericService<Produto> {

	public ProdutoServico(String nomeUnidade) {
		super(nomeUnidade);
		this.repositorio = new ProdutoRepository(this.nomeUnidade);
	}
