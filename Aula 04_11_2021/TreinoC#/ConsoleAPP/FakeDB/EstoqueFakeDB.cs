...
namespace ConsoleAPP.FakeDB
{
    public class EstoqueFakeDB
    {
        ...
        public EstoqueFakeDB()
        {
            EstoqueFakeDB.inicializarCategoria();
            EstoqueFakeDB.inicializarSubCategoria();
            EstoqueFakeDB.inicializarProdutos();
        }
